...
export const MODELS = {
    ...
    'gemini-3.1-pro-preview': {
        ...
        literouter_id: 'gemini-3.1-pro-preview',
    ...
    'grok-4.1-fast-reasoning': {
        ...
        literouter_id: 'grok-4.1-fast-reasoning',
    ...
    'grok-4.1-fast-non-reasoning': {
        ...
        literouter_id: 'grok-4.1-fast-non-reasoning',
        pricing: { input: 1.5, output: 7.5 }, // Beta discount
        rateLimit: 60,
    },
    ...
    'grok-4.20-reasoning': {
        ...
        literouter_id: 'grok-4.20-reasoning',
        pricing: { input: 0, output: 0 },
        isApiOnly: true,
        isReasoning: true,
        tempFree: true
